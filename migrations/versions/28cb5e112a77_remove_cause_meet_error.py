"""remove cause meet error

Revision ID: 28cb5e112a77
Revises: 
Create Date: 2025-08-28 17:02:47.717354
...
def upgrade():
    ...
    with op.batch_alter_table('idea', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_idea_user_id'), ['user_id'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('idea', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_idea_user_id'))
